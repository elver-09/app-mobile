                  ...
                  child: Row(
                    children: [
                      Container(
                        ...
                        child: const Icon(Icons.calendar_today, color: primaryColor, size: 20),
                      ),
                      ...
                      Expanded(
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text('Fecha seleccionada', style: TextStyle(color: Colors.grey[700], fontSize: 12)),
                      ...
                      TextButton(onPressed: _pickDate, child: const Text('Cambiar', style: TextStyle(color: primaryColor)))
                    ],
                  ),
                ),
              ),
                  ...
                  ElevatedButton(
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        const Text('Reprogramar', style: TextStyle(color: Colors.white, fontWeight: FontWeight.w600)),
                      ],
                    ),
                  ),
                ],
